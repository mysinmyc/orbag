...
typedef SubmitActionResponseConsequencesCallback<T> = void Function(BuildContext context, T value);

class ActionExecutionFeedBack extends StatelessWidget {
  final SubmitActionResponseConsequencesCallback<ActionSubmissionResultInfo>? onDeleted;
  final SubmitActionResponseConsequencesCallback<ActionSubmissionResultInfo>? onUpdated;
  final Queue<ActionSubmissionResultInfo> data;
  const ActionExecutionFeedBack(this.data, {this.onDeleted,this.onUpdated,super.key});

  Widget _buildSnackBarContent(ActionSubmissionResultInfo info) {
  ...
  bool _processQuickResult(BuildContext context, ActionSubmissionResultInfo info) {
  ...
  void _processConsequences(BuildContext context, ActionSubmissionResultInfo info) {
        ...
        SchedulerBinding.instance.addPostFrameCallback((timeStamp) {
          if (!_processQuickResult(context,info)) {
            ...
            ScaffoldMessenger.of(context)..clearSnackBars()..showSnackBar(SnackBar(
                ...
                showCloseIcon: true,
                content: _buildSnackBarContent(info)));
          }
