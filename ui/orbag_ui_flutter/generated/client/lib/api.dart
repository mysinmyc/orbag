...
part 'api/graph_controller_api.dart';
...
part 'api/tree_controller_api.dart';
...
part 'model/configuration_item_reference_list_field.dart';
part 'model/create_request.dart';
part 'model/create_response.dart';
part 'model/enum_field.dart';
part 'model/error_payload.dart';
part 'model/execute_later_response.dart';
part 'model/generate_graph_request.dart';
part 'model/generate_graph_response.dart';
part 'model/get_available_actions_request.dart';
part 'model/get_available_actions_response.dart';
part 'model/get_available_paths_request.dart';
part 'model/get_available_paths_response.dart';
part 'model/get_available_views_request.dart';
part 'model/get_available_views_response.dart';
part 'model/get_children_request.dart';
part 'model/get_children_response.dart';
part 'model/get_class_model_response.dart';
part 'model/get_root_request.dart';
part 'model/get_root_response.dart';
...
part 'model/serializable_graph.dart';
part 'model/serializable_path.dart';
part 'model/serializable_relation.dart';
